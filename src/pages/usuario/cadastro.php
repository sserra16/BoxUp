...
<div id="toast" class="fixed bottom-0 right-0 m-5 z-50 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
...
<script>
  ...
  $('#cadastrar').click(() => {
    ...
    $.ajax({
      url: "/src/api/controller/CadastroController",
      method: "POST",
      data: {
        nome,
        email,
